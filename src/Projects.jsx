    ...
    return (
        <div className={`generic-container ${theme}`}>
            ...
            <section className='projects-list'>
                ...
                <ProjectItem array={["html","css","asp.net"]} theme={theme} imageName={"petCare"} title={"Pet Care"} >Una página web dedicada al cuidado de nuestras mascotas, llevando a cabo un registro diario de las actividades de estas mismas.</ProjectItem>
            </section>
        </div>
    );
}
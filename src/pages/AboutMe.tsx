...
export default function AboutMe() {
    return (
        <div className="flex flex-col min-h-screen justify-between py-[10vh] mx-[10vw] relative">
            <header className='relative md:flex'>
                <h1 className="mb-3 md:mr-5">More About Me</h1>
                <img src='draws/Proud.png' className='hidden md:block h-[50px] md:h-[100px] w-fit' />
            </header>
            <section className='flex md:flex-row flex-col-reverse'>
                <div className=" md:w-2/3 relative my-6 md:mr-10">
